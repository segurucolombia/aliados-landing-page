    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <img src="/img/logo-seguru.png" alt="Seguru" class="h-12 w-auto mb-4 brightness-0 invert" />
          <p class="text-gray-400 mb-4">
            Protegiendo lo que más importa desde 2026. Tu seguridad es nuestra prioridad.
          </p>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
        <p>&copy; 2026 Seguru. Todos los derechos reservados.</p>
      </div>
    </div>
  </footer>
</template>
